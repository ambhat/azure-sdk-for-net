...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class AlertSettingsOperations : IServiceOperations<SiteRecoveryManagementClient>, IAlertSettingsOperations
    {
        ...
        public async Task<AzureOperationResponse<Alert>> GetWithHttpMessagesAsync(string alertSettingName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/replicationAlertSettings/{alertSettingName}").ToString();
        ...
        public async Task<AzureOperationResponse<IPage<Alert>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = Client.BaseUri.AbsoluteUri;
            var _url = new System.Uri(new System.Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/replicationAlertSettings").ToString();
            _url = _url.Replace("{resourceName}", System.Uri.EscapeDataString(Client.ResourceName));
            _url = _url.Replace("{resourceType}", System.Uri.EscapeDataString(Client.ResourceType));
            _url = _url.Replace("{resourceNamespace}", System.Uri.EscapeDataString(Client.ResourceNamespace));
            _url = _url.Replace("{resourceGroupName}", System.Uri.EscapeDataString(Client.ResourceGroupName));
