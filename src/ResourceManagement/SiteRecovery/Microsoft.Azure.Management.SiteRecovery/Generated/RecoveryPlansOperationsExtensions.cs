...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    public static partial class RecoveryPlansOperationsExtensions
    {
            ...
            /// ARM name of the job.
            /// </param>
            public static RecoveryPlan GetTrackAsyncOperation(this IRecoveryPlansOperations operations, string recoveryPlanName, string jobName)
            {
                return operations.GetTrackAsyncOperationAsync(recoveryPlanName, jobName).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<RecoveryPlan> GetTrackAsyncOperationAsync(this IRecoveryPlansOperations operations, string recoveryPlanName, string jobName, CancellationToken cancellationToken = default(CancellationToken))
            {
