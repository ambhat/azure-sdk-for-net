...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    internal partial class EventsOperations : IServiceOperations<SiteRecoveryManagementClient>, IEventsOperations
    {
        ...
        public async Task<AzureOperationResponse<EventModel>> GetWithHttpMessagesAsync(string eventName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/replicationEvents/{eventName}").ToString();
        ...
        public async Task<AzureOperationResponse<IPage<EventModel>>> ListWithHttpMessagesAsync(Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "Subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceNamespace}/{resourceType}/{resourceName}/replicationEvents").ToString();
            _url = _url.Replace("{resourceName}", Uri.EscapeDataString(this.Client.ResourceName));
            _url = _url.Replace("{resourceType}", Uri.EscapeDataString(this.Client.ResourceType));
            _url = _url.Replace("{resourceNamespace}", Uri.EscapeDataString(this.Client.ResourceNamespace));
            _url = _url.Replace("{resourceGroupName}", Uri.EscapeDataString(this.Client.ResourceGroupName));
