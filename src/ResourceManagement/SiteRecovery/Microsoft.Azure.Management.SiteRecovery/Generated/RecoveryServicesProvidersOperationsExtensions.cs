...
namespace Microsoft.Azure.Management.SiteRecovery
{
    ...
    public static partial class RecoveryServicesProvidersOperationsExtensions
    {
            ...
            /// job id to track.
            /// </param>
            public static RecoveryServicesProvider GetTrackAsyncOperation(this IRecoveryServicesProvidersOperations operations, string fabricName, string providerName, string jobName)
            {
                return operations.GetTrackAsyncOperationAsync(fabricName, providerName, jobName).GetAwaiter().GetResult();
            }
            ...
            /// </param>
            public static async Task<RecoveryServicesProvider> GetTrackAsyncOperationAsync(this IRecoveryServicesProvidersOperations operations, string fabricName, string providerName, string jobName, CancellationToken cancellationToken = default(CancellationToken))
            {
