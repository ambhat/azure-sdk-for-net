...
namespace Microsoft.Azure.Management.SiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzureEnableProtectionInput : EnableProtectionProviderSpecificInput
    {
        ...
        /// vm.</param>
        /// <param name="targetStorageAccountId">Gets or sets the storage
        /// account name.</param>
        /// <param name="targetAzureNetworkId">Gets or sets the selected target
        /// Azure network Id.</param>
        /// <param name="targetAzureSubnetId">Gets or sets the selected target
        /// Azure subnet Id.</param>
        ...
        /// enum.</param>
        /// <param name="targetAzureVmName">Gets or sets the target azure Vm
        /// Name.</param>
        /// <param name="disksToInclude">Gets or sets the list of VHD IDs of
        /// disks to be protected.</param>
