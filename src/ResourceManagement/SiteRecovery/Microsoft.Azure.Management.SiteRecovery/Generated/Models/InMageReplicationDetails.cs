...
namespace Microsoft.Azure.Management.SiteRecovery.Models
{
    ...
    public partial class InMageReplicationDetails : ReplicationProviderSpecificSettings
    {
        ...
        /// Initializes a new instance of the InMageReplicationDetails class.
        /// </summary>
        /// <param name="activeSiteType">Gets or sets the active location of
        /// the VM. If the VM is being protected
        ...
        /// <param name="osDetails">Gets or sets the OS details.</param>
        ...
        /// <param name="resyncDetails">Gets or sets the resync details of the
        /// machine</param>
        /// <param name="retentionWindowStart">Gets or sets the retention
        /// window start time.</param>
        /// <param name="retentionWindowEnd">Gets or sets the retention window
        /// end time.</param>
        ...
        /// Id.</param>
        /// <param name="consistencyPoints">Gets or sets the collection of
        /// Consistency points.</param>
        /// <param name="diskResized">Gets or sets a value indicating whether
        /// any disk is resized for this VM.</param>
        /// <param name="rebootAfterUpdateStatus">Gets or sets a value
        /// indicating whether the source server requires a restart after
        /// update.</param>
        /// <param name="multiVmGroupId">Gets or sets the multi vm group Id, if
        /// any.</param>
        /// <param name="multiVmGroupName">Gets or sets the multi vm group
        /// name, if any.</param>
        /// <param name="agentDetails">Gets or sets the agent details.</param>
        ...
        /// discovery type of the machine.</param>
        /// <param name="azureStorageAccountId">Gets or sets a value indicating
        /// the underlying Azure storage account. If
