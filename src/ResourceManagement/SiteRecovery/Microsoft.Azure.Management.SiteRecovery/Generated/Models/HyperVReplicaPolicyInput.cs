...
namespace Microsoft.Azure.Management.SiteRecovery.Models
{
    ...
    public partial class HyperVReplicaPolicyInput : PolicyProviderSpecificInput
    {
        ...
        /// Initializes a new instance of the HyperVReplicaPolicyInput class.
        /// </summary>
        /// <param name="recoveryPoints">Gets or sets a value indicating the
        /// number of recovery points.</param>
        /// <param name="applicationConsistentSnapshotFrequencyInHours">Gets or
        /// sets a value indicating the application consistent
        /// frequency.</param>
        /// <param name="compression">Gets or sets a value indicating whether
        /// compression has to be enabled.</param>
        /// <param name="initialReplicationMethod">Gets or sets a value
        /// indicating whether IR is online.</param>
        /// <param name="onlineReplicationStartTime">Gets or sets a value
        /// indicating the online IR start time.</param>
        /// <param name="offlineReplicationImportPath">Gets or sets a value
        /// indicating the offline IR import path.</param>
        /// <param name="offlineReplicationExportPath">Gets or sets a value
        /// indicating the offline IR export path.</param>
        /// <param name="replicationPort">Gets or sets a value indicating the
        /// recovery HTTPS port.</param>
        /// <param name="allowedAuthenticationType">Gets or sets a value
        /// indicating the authentication type.</param>
        /// <param name="replicaDeletion">Gets or sets a value indicating
        /// whether the VM has to be auto deleted.</param>
