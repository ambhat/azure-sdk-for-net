...
namespace Microsoft.Azure.Management.SiteRecovery.Models
{
    ...
    public partial class RecoveryPlanHyperVReplicaAzureFailoverInput : RecoveryPlanProviderSpecificFailoverInput
    {
        ...
        /// RecoveryPlanHyperVReplicaAzureFailoverInput class.
        /// </summary>
        public RecoveryPlanHyperVReplicaAzureFailoverInput(string vaultLocation, bool? canWrite = default(bool?), bool? canRead = default(bool?), string primaryKekCertificatePfx = default(string), string secondaryKekCertificatePfx = default(string), HyperVReplicaAzureRpRecoveryPointType? recoveryPointType = default(HyperVReplicaAzureRpRecoveryPointType?))
