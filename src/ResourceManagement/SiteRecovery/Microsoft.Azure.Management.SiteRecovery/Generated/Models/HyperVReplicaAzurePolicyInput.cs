...
namespace Microsoft.Azure.Management.SiteRecovery.Models
{
    ...
    public partial class HyperVReplicaAzurePolicyInput : PolicyProviderSpecificInput
    {
        ...
        /// class.
        /// </summary>
        /// <param name="recoveryPointHistoryDuration">Gets or sets the
        ...
        /// encryption needs to be enabled for Vms in this cloud.</param>
        /// <param name="storageAccounts">Gets or sets the list of storage
        /// accounts to which the VMs in the primary cloud can
        /// replicate to.</param>
